...
VOCAB_SIZE = 30000
HIDDEN_SIZE = 4200
NUM_ATTENTION_HEAD = 30
NUM_KV_ATTENTION_HEAD = 30
...
PACK = os.getenv("PACK", False)
N = os.getenv("N", 1)
M = os.getenv("M", 4)
MICRO_BATCH_SIZE = M // N if PACK else 1
TOTAL_SEQ_LEN = MICRO_BATCH_SIZE * 1024 * N if PACK else M * 1024
SEQ_LEN = TOTAL_SEQ_LEN // MICRO_BATCH_SIZE
SEQ_LEN = 4200
data = dict(
    seq_len=SEQ_LEN,
...
TP_SIZE = int(os.getenv("TP_SIZE", 4))
parallel = dict(
    zero1=dict(size=-1),
