...
MODEL_NAME = "30B_llama2"
# MODEL_NAME = "32B_qwen2"
...
SLEEP_TIME_Profiles = [[x / per_stage_layer_num for x in sublist] for sublist in [[40,80],[40,60,20]]] #per stage sleep time profile, we need compute per layer sleep time
