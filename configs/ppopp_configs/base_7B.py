...
SLEEP_TIME_Profiles = [[x / per_stage_layer_num for x in sublist] for sublist in [[100,155],[100,125,30]]] #per stage sleep time profile, we need compute per layer sleep time
