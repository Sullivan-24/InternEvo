...
SLEEP_TIME_Profiles = [[x / per_stage_layer_num for x in sublist] for sublist in [[35,70],[35,55,15]]] #per stage sleep time profile, we need compute per layer sleep time
