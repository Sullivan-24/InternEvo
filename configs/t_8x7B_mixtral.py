...
heter = False
alpa = False
layer_placement = [[1,1],[2,6],[7,11],[12,16],[17,21],[22,26],[27,31],[32,32]]
...
if tp_size == 2:
    ...
    sleep_forward_time_perlayer = 2
    sleep_backward_time_perlayer = 4
elif tp_size == 8:
    sleep_forward_time_perlayer = 1
    sleep_backward_time_perlayer = 3
...
"""
parallel = dict(
    zero1=dict(size=dp_size, fsdp=False),
